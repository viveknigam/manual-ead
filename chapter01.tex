...
Finalmente com a democratização do ensino, o conhecimento passou a ser disseminado para as massas 
...
e professores podem ser acompanhar os seus alunos à distância através de atividades como 
...
universidades brasileiras, como a Universidade de São Paulo (USP) tem também  aberto vagas para cursos 
à distância que tem a mesma validade e prestígio que os seus curso presenciais. 
A Universidade Federal da Paraíba (\ufpb) abriu cursos de licenciatura em 
diversas áreas, como Computação, Pedagogia, Ciências Biológicas, Ciências Agrárias, e Matemática,
com o objetivo de atender as necessidades de ensino das regiões da Paraíba e Nordeste que não tem acesso fácil
...
através do Ambiente Virtual de Aprendizagem. Educadores publicam no \ava\ atividades ou iniciam 
uma discussão através de um fórun, ou pedem a opinião dos seus alunos através de pesquisas 
de opinião. 

Esta interação através do \ava\ é fundamental para o bom andamento da disciplina, já que permite o 
educador monitorar o avanço e deficiências dos seus alunos, levando o aluno a aumentar o interesse
pela disciplina, mesmo que o ensino não seja presencial. 
Contudo, devido ao número grande de ferramentas disponíveis, muitos educadores 


De fato, muitas vezes o Ensino à Distância 
